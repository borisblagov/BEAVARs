...
Σt  = .0010*Matrix(I,n,n); Σt_inv = inv(Σt)
...
nsave = 500;
nburn = 500;
store_YY, store_beta = BEAVARs.CPZ_loop!(YY,p,hypSetup,nu0,n,k,b0,B_draw,Σt_inv,structB_draw,YYt,longyo,Y0,cB,sBd_ind,Σt_ind,Xb,cB_b0_ind,H_Bsp,Σ_invsp,Sm_bit,Smsp,Sosp,nm,MOiM,MOiz,nburn,nsave,Tf);
